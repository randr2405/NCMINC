    ...
    <div className="text-black">
      ...
      <section className="px-8 py-16 text-white" style={{ backgroundColor: 'var(--ncm-black)' }}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          {tagline && (
            <p className="text-lg font-semibold mb-6" style={{ color: 'var(--ncm-teal)' }}>{tagline}</p>
          )}
      ...
      <section className="px-8 py-16 max-w-5xl mx-auto">
        <div className="grid md:grid-cols-2 gap-8">
          {sections.map((s) => (
            <div key={s.title} className="p-6 rounded-lg border" style={{ borderColor: 'var(--ncm-grey)' }}>
              <h3 className="font-semibold text-lg mb-3" style={{ color: 'var(--ncm-teal)' }}>{s.title}</h3>
        ...
        <section className="px-8 py-16" style={{ backgroundColor: 'var(--ncm-grey)' }}>
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              {valuePoints.map((v) => (
                <div key={v} className="flex items-start gap-3 bg-white p-4 rounded-lg border" style={{ borderColor: 'var(--ncm-grey)' }}>
                  <span style={{ color: 'var(--ncm-teal)' }}>✔</span>
      ...
      {/* CTA */}
      <section className="px-8 py-16 text-center text-white" style={{ backgroundColor: 'var(--ncm-teal)' }}>
